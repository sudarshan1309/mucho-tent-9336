...
public class Main {
	...
	public static void main(String[] args) {
		...
		while(mainFlag) {
			System.out.println("1. Register a crime records");
			...
			case 1:
				...
				while(insertFlag) {
					...
					System.out.println("3. Register a new Victim");
					...
					case 2:
						...
						System.out.println("Enter an indentifying mark in the criminal's face");
						String mark = sc.nextLine();
						System.out.println("Enter the police station id in which the criminal was first arrested if no arrested enter 0");
